<?php defined('BASEPATH') OR exit('No direct script access allowed');
	 ...
	 * @property MX_Config           $config               This class contains functions that enable config files to be managed
	 ...
	 * @property MX_Lang             $lang                 Language Class
	 * @property MX_Loader           $load                 Loads framework components.
	 * @property CI_Log              $log                  Logging Class
	 * @property CI_Model            $model                Model Class
	 * @property CI_Output           $output               Responsible for sending final output to the browser.
	 * @property MX_Router           $router               Parses URIs and determines routing
	 ...
	 * @property CI_Benchmark        $benchmark            This class enables you to mark points and calculate the time difference between them. Memory consumption can also be displayed.
	 * @property MX_Config           $config               This class contains functions that enable config files to be managed
	 * @property MX_Controller       $controller           This class object is the super class that every library in CodeIgniter will be assigned to.
	 * @property CI_Exceptions       $exceptions           Exceptions Class
	 * @property CI_Hooks            $hooks                Provides a mechanism to extend the base system without hacking.
	 * @property CI_Input            $input                Pre-processes global input data for security
	 * @property MX_Lang             $lang                 Language Class
